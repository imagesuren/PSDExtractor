...
- (NSString *) createPDFPresentationFromFiles:(NSArray *)fromFiles toFile:(NSURL *)toFile withOptions:(PhotoshopCCPresentationOptions *)withOptions;  // create a PDF presentation file
...
- (NSString *) createPhotoGalleryFromFolder:(id)fromFolder toFolder:(NSURL *)toFolder withOptions:(PhotoshopCCGalleryOptions *)withOptions;  // Creates a web photo gallery
...
- (PhotoshopCCDocument *) saveIn:(NSURL *)in_ as:(PhotoshopCCSvFm)as copying:(BOOL)copying appending:(PhotoshopCCE300)appending withOptions:(PhotoshopCCSaveOptions *)withOptions;  // save the specified document
...
- (void) exportIn:(NSURL *)in_ as:(PhotoshopCCE640)as withOptions:(PhotoshopCCExportOptions *)withOptions;
...
@property PhotoshopCCLB00 source;  // source for the depth map (default: none )
...
@property PhotoshopCCLB03 irisShape;  // shape of the iris (default: hexagon )
...
@property PhotoshopCCE745 distribution;  // distribution value for the noise (default: uniform )
